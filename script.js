...
try {
		...
		const anu = await conn.chats.all()
		...
		const katalog = (teks) => {
             res = conn.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© Dcode Denpa_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             conn.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = conn.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Dgt6JhzTvlmEor8Zz23fHx', "groupName": `${NamaBot}`, "footerText": "*_© Dcode Denpa_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
if (tebakgambar.hasOwnProperty(from.split('@')[0]) && !isCmd) {
            ...
            //Siapa aku
/*if (siapaaku.hasOwnProperty(from.split('@')[0]) && !isCmd) {
                kuis = true
...
break
case 'siapaaku':
if (tebakgambar.hasOwnProperty(from.split('@')[0])) return reply("Selesaikan pertanyaan sebelumnya!")
att = await fetchJson(`https://api.zeks.me/api/siapa-aku?apikey=PerwiraGans`)
jawaban = att.data.jawaban
teksy = `*[ Siapa Aku ]*

*Soal :* ${att.data.soal}
`
conn.sendMessage(from, teksy, text, {quoted: mek}).then(() => {
              tebakgambar[from.split('@')[0]] = jawaban.toLowerCase()
              fs.writeFileSync("./database/tebakgambar.json", JSON.stringify(tebakgambar))
})
await sleep(50000)
if (tebakgambar.hasOwnProperty(from.split('@')[0])) {
              reply(`*Jawaban :* ${att.data.jawaban}`)
              delete tebakgambar[from.split('@')[0]]
              fs.writeFileSync("./database/tebakgambar.json", JSON.stringify(tebakgambar))
}
break
...
break
case 'darkjokes':
gok = await fetchJson(`https://api.zeks.me/api/darkjokes?apikey=PerwiraGans`)
butty = await getBuffer(gok.result)
...
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/textpro/futuristic-technology?text=${encodeURI(q)}`)
...
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/textpro/neon-devil-wings?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
...
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/textpro/black-white-bear-mascot?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
...
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/flaming-fire?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
...
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/metalic-gold?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
...
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/shadow-sky?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
...
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/teks-cup?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
...
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/romantic-messages?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
...
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/burn-paper?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
...
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/funny-cup?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
...
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/love-messages?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
...
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/under-grass?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
...
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/romantic-double?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
...
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/coffee-cup?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'woodlove':
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/wood-hearth?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'woodflower':
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/wooden-boards?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'wolfmetal':
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/wolf-metal?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'ocean':
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/underwater?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'goldflower':
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/golden-roses?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'woodenfall':
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/under-fall?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'glowtext':
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/neon-glow?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'yellowtext':
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/3d-glowing?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'orangetext':
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/vintage-text?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'honey':
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/honey-text?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'nature':
if (args.length < 1) return reply(`Masukkan teksnya
...
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/glow-rainbow?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'stars':
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/write-stars?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'fur':
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/fur-effect?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'cromium':
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/crisp-chrome?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'hellokitty':
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/embroidery-text?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'glowrainbow2':
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/3d-rainbow-bg?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'yellow3d':
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/striking-3d?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'watermelon':
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/summer-watermelon?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'matrix2':
if (args.length < 1) return reply(`Masukkan teksnya
...
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/butter-fly?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'blackwood':
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/wooden-3d-black?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'multimetal':
if (args.length < 1) return reply(`Masukkan teksnya
...
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/harry-poter?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'lightblue':
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/neon-lights?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'coofe':
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/put-coffee-cup?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'scary':
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/text-on-scary?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'purplesmoke':
if (args.length < 1) return reply(`Masukkan teksnya
Contoh: ${prefix}${command} Perwira`)
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/smoke-typography?text=${encodeURI(q)}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'partyneon':
if (args.length < 1) return reply(`Masukkan teksnya
...
case 'tebakgambar':
              if (tebakgambar.hasOwnProperty(from.split('@')[0])) return reply("Selesaikan pertanyaan sebelumnya")
              get_result = await fetchJson(`https://api.zeks.me/api/tebakgambar?apikey=PerwiraGans`)
              ini_image = get_result.result.soal
...
conn.sendMessage(from, `*🎳 Memulai Game Tictactoe 🎲*
...
break*/
				case 'bc':
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
						sendMess2(_.jid, `*『 Broadcast by Owner 』*\n\n───────────────────\n\`\`\`${body.slice(4)}\`\`\`\n───────────────────\n\n*Thanks*`)
						}
...
└ ❏ *Link:* ${items[i].url}\n\n`
                ...
                await conn.sendMessage(from, thumb, image, {quoted: mek, caption: `${hehe}───────────────\n\n┌ ◪ *DOWNLOAD*
...
case 'music':
				case 'lagu':
				gog = args.join(" ")
              bonn = await fetchJson(`https://api.zeks.me/api/ytplaymp3?apikey=PerwiraGans&q=${gog}`)
              title = `${bonn.result.title}`
              thumb = await getBuffer(bonn.result.thumbnail)
              ukuran = `${bonn.result.size}`
              tipet = `${bonn.result.ext}`
              duration = `${bonn.result.duration}`
              mp3 = await getBuffer(bonn.result.url_audio)
              mentu = `*YT Play YouTube Mp3*
...
Jika Error gunakan command #music judul lagu
`
...
case 'gifstiker':
            ...
            fs.unlinkSync(ran)
                ...
                reply(`Kirim gambar dengan caption ${prefix}sticker\nDurasi Sticker Video 1-3 Detik`)
            }
            break
				/*case 'sticker':
					case 'stiker':
